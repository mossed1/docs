...
<Image src="/assemble/Step1.png" alt="Step 1" width={288} height={216} />
...
<Image src="/assemble/Step2.png" alt="Step 2" width={288} height={216} />

### Assemble the Chassis Structure

- Connect the Chassis Upper (v9) and Chassis Lower (v9) by securing the Chassis Connector Screen Support with four M3 20MM screws.

<Image src="/assemble/Step3.png" alt="Step 3" width={288} height={216} />

### Assemble the Arm Suspension Components

- Assemble the Arm Suspension components by installing two Secondary Axles (x2)
- Two Upper Strut Mounts (x2), and two Springs (x2) into the chassis, ensuring proper alignment as shown.

<Image src="/assemble/Step4.png" alt="Step 4" width={288} height={216} />
...
- Assemble two Arm Suspension Mounts by attaching an Arm Spring Divider (left and right) and a 608 bearing (metal or printed) to each mount, ensuring proper fitment.

<Image src="/assemble/Step5.png" alt="Step 5" width={288} height={216} />

### Assemble the Servo and Upper Arm
- Connect the Servo to the RPI first, ensuring the PORT and STARBOARD servos are connected to pins 1 and 2 (the first pin is 0). 
- Attach the Arm Upper Servo Horn to the servo using the provided servo horn screw.

<Image src="/assemble/Step6.png" alt="Step 6" width={288} height={216} />
...
<Image src="/assemble/Step7.png" alt="Step 7" width={288} height={216} />
...
<Image src="/assemble/Step8.png" alt="Step 8" width={288} height={216} />
...
<Image src="/assemble/Step9.png" alt="Step 9" width={288} height={216} />
...
<Image src="/assemble/Step10.png" alt="Step 10" width={288} height={216} />
